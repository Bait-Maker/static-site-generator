...
class TestSplitNodes(unittest.TestCase):
    ...
    def test_split_multiple_images(self):
        ...
        new_nodes = split_nodes_image([test, test2])
        self.assertEqual(
            [
                TextNode("This is text with an ", TextType.TEXT),
                TextNode("image", TextType.IMAGE, "https://i.imgur.com/zjjcJKZ.png"),
    ...
    def test_split_multiple_links(self):
        ...
        node2 = TextNode(
            "This is another text with a link [to boot dev2](https://www.boot.dev) and [to youtube2](https://www.youtube.com/@bootdotdev)",
            TextType.TEXT,
        )
        ...
        self.assertEqual(
            [
                ...
                TextNode("to boot dev2", TextType.LINK, "https://www.boot.dev"),
                TextNode(" and ", TextType.TEXT),
                TextNode(
                    "to youtube2",
                    TextType.LINK,
    ...
    def test_split_links_text_follow(self):
        node = TextNode(
